            ...
            <form onSubmit={handleSubmit(Submit)} >
              <div className="select-items">
                ...
                <div>
                  ...
                  <input className="addPostInput" className="addPostInput" placeholder="اسم الإعلان " name="title" ref={register} required />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select name="location" required ref={register} >
                    <option >عمان</option>
                    <option >اربد</option>
